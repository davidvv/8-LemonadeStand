...
struct customer {
    var taste = 0 //el gusto se genera con una función aleatoria de 11 valores dividida entre 10 (para que salga entre 0 y 1). Despues lo que haré será comprobar en qué valor de acidez está su gusto y compararlo con el de la limonada del día. 
