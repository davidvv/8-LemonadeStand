...
class ViewController: UIViewController {
    ...
    var weatherImage:UIImage = UIImage(named: "Mild")!
    ...
    override func viewDidLoad() {
        ...
        weatherImageView1.image = weatherImage
        weatherImageView2.image = weatherImage
        weatherImageView3.image = weatherImage
        weatherImageView4.image = weatherImage
